...
const categories = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Gum Treatment", desc: "Scaling and root planing to treat gum disease and restore gum health." },
      { name: "Night Guards", desc: "Custom-fit guards to protect your teeth from grinding and sports injuries." },
    ],
  },
];
    ...
    <PageLayout>
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-2xl">
          <FadeInSection>
            <p className="text-accent font-medium text-sm tracking-widest uppercase mb-6">Our Services</p>
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-foreground mb-6">
              Comprehensive{" "}
              <span className="italic font-normal">Dental Care</span>
            </h1>
        ...
        <div className="container mx-auto px-4 lg:px-8">
              ...
              <FadeInSection key={cat.title} delay={ci * 0.05}>
                <div>
                  <div className="flex items-center gap-4 mb-10">
                    <h2 className="font-heading text-2xl font-semibold text-foreground whitespace-nowrap">
                      {cat.title}
                    </h2>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {cat.services.map((s) => (
                      <div
                        key={s.name}
                        className="bg-card rounded-lg p-6 shadow-sm border border-border hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                      >
                        <h3 className="font-heading text-lg font-semibold text-foreground mb-3">{s.name}</h3>
          ...
          <FadeInSection delay={0.1}>
            <div className="text-center mt-20">
              <p className="text-muted-foreground mb-5">Ready to get started?</p>
